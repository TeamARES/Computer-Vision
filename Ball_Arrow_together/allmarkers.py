    ...
    try:
     ...
     #                  fps = FPS().start()
        ...
        #     blur = cv2.GaussianBlur(dilation, (5, 5), 0)
            ...
            threshold = cv2.adaptiveThreshold(img, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY_INV, 25, 20)
                ...
                if area > 400:  
                    ...
                    if(len(approx) == 7):
                       ...
                       # G = cv2.moments(ellipse)
                        ...
                        cv2.arrowedLine(frame,(cxx,cyy),(cx,cy),(255,0,0),2)
                        print("Slope of arrow (degrees) : ")
                        print(slope)
                        decision = quadrant(slope)
                        print("Quadrant of arrow facing :")
                        print(decision)
